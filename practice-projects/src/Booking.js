            ...
            <Container>
                <Row className='rounded-2 d-flex  text-start' style={{ margin: "-37px", transform: "translateY(22px)", }}>
                    <Col className='booking my-1'>
                        ...
                        <button className='px-5 border-0 py-2 me-1 rounded-2' onClick={() => setOpenDate(!openDate)}  >{`${format(date[0].startDate, "MM/dd/yyyy")} to ${format(date[0].endDate, "MM/dd/yyy")}`}</button>
                        ...
                        <button className='px-5 border-0 py-2 rounded-2' style={{ backgroundColor: "blue", color: "white" }}>Search</button>
                    </Col>
                </Row>
            </Container>
